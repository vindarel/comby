...
(** substitute the pattern :[id()] with a fresh hex string based on the last
    48-bit part of a UUID v3 identifier. Environment is passed because holes may
    be used to specify labels for fresh identifiers. *)
val substitute_fresh : Environment.t -> string -> string
